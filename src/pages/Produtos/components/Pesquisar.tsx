  ...
  return (
    <Drawer.Root size="md" open={open} onOpenChange={(e) => setOpen(e.open)}>
      <Drawer.Trigger asChild>
        <IconButton p={3} size="md" ml={3} bg={COLORS.amarelo} rounded={5}>
            <LuSearch /> Pesquisar
        </IconButton>
      </Drawer.Trigger>
      <Portal>
                  ...
                  <Stack gap="4">
                    ...
                    <Flex>
                      <Field.Root width="100%">
                        ...
                        <Input name="preco" type="text" onChange={formik.handleChange} value={formik.values.preco} />
                      </Field.Root>

                      <Field.Root ml={4} width="100%">
                        <Field.Label>Categoria</Field.Label>
                        <Input name="categoria" type="text" onChange={formik.handleChange} value={formik.values.categoria}/>
                      </Field.Root>
                    </Flex>

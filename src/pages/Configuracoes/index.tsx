...
import { DadosPessoais, Detalhes, MinhaConta, MudarSenhaActual, Pesquisar, Relatorios } from './components'
  ...
  return (
    <Box bg={COLORS.bg.cinzaPage} minHeight="100vh">
        ...
        <Flex>
            ...
            <Title title="Configurações" description="Gerencie e actualize os seus dados" />
             ...
             :
                <Box mt={5} bg={COLORS.bg.branco} p={10} rounded={10} shadow="sm">
                        ...
                        <Flex alignItems={"center"}> 
                            ...
                            <Box ml={10}>
                                <Heading>{entidadeData?.nomeCliente}</Heading>
                                <Text fontSize={14} color={COLORS.cinza}>{entidadeData?.emailCliente}</Text>
                                <Text fontSize={14} fontWeight={700} color={COLORS.vermelho}>{entidadeData?.businessPartnerId}</Text>
                            </Box>
                        </Flex>

                        <Tabs.Root mt={10} defaultValue="members">
                            <Tabs.List>

  ...
  const [load, setLoad] = useState(false)
    ...
    const exclusao = async (id:string) => {
        ...
        try {
          ...
          const response = await RequestAPI.delete(`clientes/${id}`)
          ...
          <Drawer.Content>
            ...
            <Drawer.Body p={10}>
              ...
              <Box mt={5} fontSize={14} fontWeight={300}>
                ...
                <Flex mb={5} justifyContent="center">
                  <Button bg={COLORS.amarelo} loading={load} onClick={()=>exclusao(data.clienteId)} color={COLORS.preto} width={[150]} rounded={10}>Excluir</Button>

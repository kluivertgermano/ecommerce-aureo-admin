...
import { Box,  Button,  CloseButton, Drawer, Field, Flex, Heading, HStack, IconButton, Image, Input, Portal, RadioGroup, Stack} from "@chakra-ui/react"
                  ...
                  <Stack gap="4">
                    ...
                    <Flex>
                      <Field.Root width="100%">
                        ...
                        <Input name="data_transacao" type="date" onChange={formik.handleChange} value={formik.values.data_transacao}/>
                      </Field.Root>

                      <Field.Root ml={4}width="100%">
                        <Field.Label>Hora da transação</Field.Label>
                        <Input name="hora_transacao" type="time" onChange={formik.handleChange} value={formik.values.hora_transacao} />
                      </Field.Root>
                    </Flex>

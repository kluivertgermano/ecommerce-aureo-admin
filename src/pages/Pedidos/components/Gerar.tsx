...
import { Alert, Box,  Button,  CloseButton, Drawer, Field, Flex,  Heading,  HStack,  IconButton, Input, Portal, RadioGroup, Stack, Text, Textarea} from "@chakra-ui/react"
                    ...
                    <Stack gap="4" mt={5}>
                      <Flex>
                        <Field.Root width="100%">
                          ...
                          <Flex>
                            <BuscarProduto />
                            <Input type="text" required name="data_limite_pagamento" onChange={formik.handleChange} value={formik.values.data_limite_pagamento}/>
                          </Flex>
                        </Field.Root>
                        <Field.Root ml={4} width="100%">
                          <Field.Label>Número de cotaçao</Field.Label>
                          <Input type="text" disabled required name="data_limite_pagamento" onChange={formik.handleChange} value={formik.values.data_limite_pagamento}/>
                        </Field.Root>
                      </Flex>
                      <Flex>
                          <Field.Root width="100%">
                      ...
                      <Flex>
                        ...
                        <Field.Root ml={4}width="100%">
                          ...
                          <Input type="text" disabled name="montante_fixo" onChange={formik.handleChange} value={formik.values.montante_fixo}/>
                        </Field.Root>
                      </Flex>
                    </Stack>
                  </Stack>
